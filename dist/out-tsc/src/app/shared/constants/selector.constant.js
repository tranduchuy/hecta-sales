...
// @ts-ignore
var cityDistrictProject_json_1 = require("./cityDistrictProject.json");
var priceLevel = [
...
var vipTypeList = [{ 'name': 'Tin thường', 'id': '5' }, { 'name': 'Tin ưu đãi', 'id': '4' }, {
        'name': 'Tin Vip 3',
        'id': '3'
    }, { 'name': 'Tin Vip 2', 'id': '2' }, { 'name': 'Tin Vip 1', 'id': '1' }, { 'name': 'Vip đặc biệt', 'id': '0' }];
var directionList = [{ 'name': 'KXĐ', 'value': '0' }, { 'name': 'Đông', 'value': '1' }, {
        'name': 'Tây',
        'value': '2'
...
var unitPriceList = [113.636, 47.272, 30, 14, 275, 1.2, 0];
var unitPriceListNew = [168.181, 68.181, 50, 27.272, 454.545, 1.727, 0];
var areaList = [
...
var result = {
    ...
    cateListBuy: cateListBuy,
    unitPriceList: unitPriceList,
    unitPriceListNew: unitPriceListNew,
    priceLevel: priceLevel,
    areaList: areaList,
    cityDistrictProject: cityDistrictProject_json_1.default,
    sortPost: sortPost
};
exports.default = result;
//# sourceMappingURL=selector.constant.js.map